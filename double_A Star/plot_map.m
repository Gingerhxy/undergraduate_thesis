function  plot_map( map,obstacle,open,close,open_back,close_back)
...
hold on;
%pause(0.1);
plot3(close_back(:,1)+0.5,close_back(:,2)+0.5,close_back(:,3)+0.5,'sr','MarkerFaceColor','r');
hold on;
%pause(0.1);
plot3(open_back(:,1)+0.5,open_back(:,2)+0.5,open_back(:,3)+0.5,'sg','MarkerFaceColor','g');
hold on;
%pause(0.1);
